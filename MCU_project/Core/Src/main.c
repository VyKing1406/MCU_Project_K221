...
int main(void)
{
  ...
  HAL_TIMEx_PWMN_Start(&htim3, Channel1);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PED_BUTTON_Pin Mode_Button_Pin Add_Button_Pin */
  GPIO_InitStruct.Pin = PED_BUTTON_Pin|Mode_Button_Pin|Add_Button_Pin;
